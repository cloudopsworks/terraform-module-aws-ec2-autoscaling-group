...
#     interruption_behavior: hibernate | stop | terminate    # defaults to terminate
#     instance_type: one-time | persistent    # defaults to null
#     block_duration_minutes: `null`  # (optional) must be multiple of 60
