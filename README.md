...
- Launch Template tag specifications for instances, EBS volumes, and Spot instance requests.
...
asg:
  ...
  # extra_tags: {} # (Optional) Additional tags merged into Launch Template tag specifications; applied to instances, attached EBS volumes, and Spot instance requests when spot.enabled=true. Default: {}.
  # backup:
...
inputs = {
  ...
  asg = {
    ...
    # Tags below are applied to instances, attached EBS volumes, and — when
    # spot.enabled = true — to Spot instance requests as well.
    extra_tags = {
      CostCenter = "platform"
    }
  }
